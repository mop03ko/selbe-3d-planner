...
<main class="workspace">
 ...
 <section class="stage" aria-label="3D ажлын талбар">
  ...
  <div class="scene-caption"><span class="eyebrow">СЭЛБЭ / <span id="floor-caption">01</span></span><h2 id="scene-title">Нэгдүгээр давхар</h2><span id="scene-meta">Бүх өрөөний зохион байгуулалт</span><a id="room-render-link" class="room-render-link" href="./renders.html?layout=saved" hidden>${icon('camera')}Энэ өрөөний рендер ${icon('arrow')}</a></div>
...
function renderRooms(){
 ...
 $('#room-render-link').hidden=!r;$('#room-render-link').href=r?`./renders.html?layout=saved&room=${encodeURIComponent(r.id)}`:'./renders.html';
