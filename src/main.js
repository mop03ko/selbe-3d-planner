...
<main class="workspace">
 <aside class="left-panel" aria-label="Давхар ба өрөөнүүд">
  ...
  <div class="left-bottom"><button id="inspiration" class="inspiration-button">${icon('palette')}<span>Интерьерийн санаанууд</span>${icon('arrow')}</button><button id="mobile-import" class="quiet mobile-import">${icon('upload')}Хувилбар оруулах</button><button id="guide" class="quiet">${icon('help')}Хэрхэн ашиглах вэ?</button><button id="source" class="source-note">Эх зурагт суурилсан концепц ${icon('arrow')}</button></div>
 </aside>
